          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" action="simpan_penjualan.php" method="POST">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nofaktur</label>
                              <div class="col-sm-10">
                                  <input name="no" type="text" class="form-control">
                              </div>
                          </div>
                                                         <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Faktur</label>
                              <div class="col-sm-10">
